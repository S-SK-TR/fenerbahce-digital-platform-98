...
- `CLAUDE.md` dosyasındaki `Fenerbahçe Kulübü Resmi Web Platformu`, `Fenerbahçe Kulübü Resmi Web Platformu — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
